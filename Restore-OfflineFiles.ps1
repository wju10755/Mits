...
Set-RegistryKeyValue -Path $registryPath -Name "Enabled" -Value 1

# Output result
Write-Host "Offline File Sync has been enabled. Please restart the computer for changes to take effect."
