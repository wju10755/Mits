...
$host.UI.RawUI.WindowTitle = 'MITS Windows Utility'
...
"@		
	...
	$command = "powershell.exe -NoProfile -ExecutionPolicy Bypass -Command 'irm https://bit.ly/MITSutil | iex'"
...
function Set-WinUtilRestorePoint {
    ...
    $ProgressPreference = 'SilentlyContinue'
    $existingRestorePoints = Get-ComputerRestorePoint | Where-Object { $_.CreationTime.Date -eq (Get-Date).Date } | Out-Null
    $ProgressPreference = 'Continue'
...
function Invoke-WPFButton {
    ...
    #[System.Windows.MessageBox]::Show("$Button","MITS Windows Utility","OK","Info")
...
Function Invoke-WPFFormVariables {
    ...
    Write-Host ""
    Write-Host "MMMMMMMM               MMMMMMMM   IIIIIIIITTTTTTTTTTTTTTTTTTTTTTT   SSSSSSSSSSSSSSS " -ForegroundColor "Red"
    Write-Host "M:::::::M             M:::::::M   :::::::IT:::::::::::::::::::::T SS:::::::::::::::S" -ForegroundColor "Red"
    Write-Host "M::::::::M           M::::::::M   :::::::IT:::::::::::::::::::::TS:::::SSSSSS::::::S" -ForegroundColor "Red"
    Write-Host "M:::::::::M         M:::::::::M   ::::::IIT:::::TT:::::::TT:::::TS:::::S     SSSSSSS" -ForegroundColor "Red"
    Write-Host "M::::::::::M       M::::::::::M   I::::I  TTTTTT  T:::::T  TTTTTTS:::::S            " -ForegroundColor "Red"
    Write-Host "M:::::::::::M     M:::::::::::M   I::::I          T:::::T        S:::::S            " -ForegroundColor "Red"
    Write-Host "M:::::::M::::M   M::::M:::::::M   I::::I          T:::::T         S::::SSSS         " -ForegroundColor "Red"
    Write-Host "M::::::M M::::M M::::M M::::::M   I::::I          T:::::T          SS::::::SSSSS    " -ForegroundColor "Red"
    Write-Host "M::::::M  M::::M::::M  M::::::M   I::::I          T:::::T            SSS::::::::SS  " -ForegroundColor "Red"
    Write-Host "M::::::M   M:::::::M   M::::::M   I::::I          T:::::T               SSSSSS::::S " -ForegroundColor "Red"
    Write-Host "M::::::M    M:::::M    M::::::M   I::::I          T:::::T                    S:::::S" -ForegroundColor "Red"
    Write-Host "M::::::M     MMMMM     M::::::M   I::::I          T:::::T                    S:::::S" -ForegroundColor "Red"
    Write-Host "M::::::M               M::::::MI I::::::II      TT:::::::TT      SSSSSSS     S:::::S" -ForegroundColor "Red"
    Write-Host "M::::::M               M::::::MI ::::::::I      T:::::::::T      S::::::SSSSSS:::::S" -ForegroundColor "Red"
    Write-Host "M::::::M               M::::::MI ::::::::I      T:::::::::T      S:::::::::::::::SS " -ForegroundColor "Red"
    Write-Host "MMMMMMMM               MMMMMMMMI IIIIIIIII      TTTTTTTTTTT       SSSSSSSSSSSSSSS   " -ForegroundColor "Red"
    Write-Host ""
    Write-Host "=====MITS Windows Utility Launcher=====" -ForegroundColor "Red"
...
function Invoke-WPFShortcut {
    ...
    Switch ($ShortcutToAdd) {
        "WinUtil" {
            ...
            $IRM = 'irm https://bit.ly/MITSutil | iex'
...
$inputXML = '<Window x:Class="WinUtility.MainWindow"
        ...
        Title="MITS Windows Utility" Height="800" Width="1200">
                        ...
                        <ControlTemplate.Triggers>
                            <Trigger Property="IsMouseOver" Value="True">
                                ...
                                <Setter Property="Effect">
                                    <Setter.Value>
                                        <DropShadowEffect Opacity="1" ShadowDepth="5" Color="White" Direction="-100" BlurRadius="45"/>
                                    </Setter.Value>
                                </Setter>
    ...
    <Border Name="WPFdummy" Grid.Column="0" Grid.Row="1">
            <Grid Background="{MainBackgroundColor}" ShowGridLines="False" Name="WPFMainGrid"  Width="Auto" Height="Auto">
                ...
                <DockPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    <Image Height="50" Width="50" Name="WPFIcon" SnapsToDevicePixels="True" Source="C:\temp\AdvanceA.jpg" Margin="0,10,0,10"/>
...
$sync.configs.themes = '{
    "Classic":  {
                    ...
                    "ButtonBackgroundMouseoverColor":  "#FF0022",
    ...
    "matrix":  {
                   ...
                   "LabelboxForegroundColor":  "#F70B0B",
                   ...
                   "ButtonBackgroundPressedColor":  "#FFFFFF",
                   "ButtonBackgroundMouseoverColor":  "#ff0022",
                   "ButtonBackgroundSelectedColor":  "#df1836",
...
Invoke-WPFRunspace -ScriptBlock {
    ...
    $sync.ComputerInfo = Get-ComputerInfo *> $null
...
$sync["Form"].Add_Loaded({
    ...
    $downloadUrl = "https://advancestuff.hostedrmm.com/labtech/transfer/installers/AdvanceA.png"
...
$downloadUrl = "https://advancestuff.hostedrmm.com/labtech/transfer/installers/AdvanceSmallA2.png"
$destinationPath = Join-Path $env:TEMP "cttlogo.png"
